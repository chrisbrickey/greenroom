...
def register_discovery_tools(mcp: FastMCP) -> None:
    ...
    def discover_films(
        ...
        language, and sorting preferences.
        ...
        """
        # Validate parameters
        _validate_discovery_params_internal("film", year, page, max_results, language, sort_by)
...
def _validate_discovery_params_internal(
    ...
    """
    if media_type not in ["film"]:
        raise ValueError(f"media_type must be 'film', got '{media_type}'")
...
def _filter_incomplete_films(films_data: list):
    """Backwards-compatible wrapper for filtering incomplete films.
...
def _format_discovery_response(
    ...
    for film in films:
        result_dict = {
            ...
            "genre_ids": film.genre_ids if film.genre_ids else []
        }
