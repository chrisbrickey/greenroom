"""Tests for the discover-flow helpers (fetch_films, fetch_television) in discovery/discover_tools.py."""

import pytest

from greenroom.tools.discovery import fetch_films, fetch_television
