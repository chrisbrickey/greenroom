...
def test_filter_incomplete_films():
    """Test that _filter_incomplete_films validates and filters film data."""
    films_data = [
    ...
    result = _filter_incomplete_films(films_data)
...
def test_format_discovery_response():
    ...
    result = _format_discovery_response(films, raw_data, page=1)
